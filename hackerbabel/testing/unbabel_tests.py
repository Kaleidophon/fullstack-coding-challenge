...
class UnbabelClientTestCase(TestCase):
    """
    Test for the UnbabelClient which handles to the communication to the
    Unbabel API (in Sandbox mode, though).
    """
    ...
    def test_translation(self):
        """
        Test whether the authentication data is correct and the translation
